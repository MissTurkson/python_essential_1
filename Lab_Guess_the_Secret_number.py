...
# and be prompted to enter a number again. If the number entered by the user matches
# the number picked by the magician, the number should be printed to the screen,
# and the magician should say the following words: "Well done, muggle! You are free now."
#The magician is counting on you! Don't disappoint him

secret_number = 777
guessed_number = int(input("Enter an integer value: "))
while True:
    if guessed_number  == secret_number:
        print(guessed_number, "Welldone muggle! You are free now")
        break

    else:
        print("Ha ha! You are stuck in my loop")
        guessed_number = int(input("Enter another value: "))
